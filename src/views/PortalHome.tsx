          ...
          <div className="mb-8">
            ...
            <div className="flex gap-4 overflow-x-auto pb-4 hide-scrollbar snap-x snap-mandatory">
              {webStories.map(story => (
                 <button 
                   key={story.id} 
                   onClick={() => onSelectWebStory && onSelectWebStory(story.slug)} 
                 ...
                 >
                    {story.pages && story.pages[0] && (
                       <img loading="lazy" src={story.pages[0].imageUrl} alt={story.pages[0].imageAlt} referrerPolicy="no-referrer" className="absolute inset-0 w-full h-full object-cover opacity-80 group-hover:scale-105 transition-transform duration-500" />
                    )}
        ...
        <div className="mt-16 grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12 flex-1 pb-8">
          ...
          <div className="flex flex-col bg-white dark:bg-zinc-950 p-6 shadow-sm rounded-xl border border-zinc-100 dark:border-zinc-800 transition-colors">
            <div className="flex items-center justify-between border-b-[3px] border-zinc-100 dark:border-zinc-800 pb-3 mb-6 transition-colors">
              <h3 className="text-xl font-black uppercase text-zinc-950 dark:text-white tracking-wider">Geral</h3>
          ...
          <div className="flex flex-col bg-white dark:bg-zinc-950 p-6 shadow-sm rounded-xl border border-zinc-100 dark:border-zinc-800 transition-colors">
            <div className="flex items-center justify-between border-b-[3px] border-zinc-100 dark:border-zinc-800 pb-3 mb-6 transition-colors">
              <h3 className="text-xl font-black uppercase text-zinc-950 dark:text-white tracking-wider">Cultura</h3>
              <button className="flex items-center text-zinc-600 dark:text-zinc-400 font-bold text-xs hover:text-[#cc0000] dark:hover:text-red-500 uppercase tracking-wider transition-colors">
                Ver todas <ChevronRight className="w-3.5 h-3.5 ml-0.5"/>
              </button>
            </div>
          ...
          <div className="flex flex-col bg-white dark:bg-zinc-950 p-6 shadow-sm rounded-xl border border-zinc-100 dark:border-zinc-800 transition-colors">
            <div className="flex items-center justify-between border-b-[3px] border-zinc-100 dark:border-zinc-800 pb-3 mb-6 transition-colors">
              <h3 className="text-xl font-black uppercase text-zinc-950 dark:text-white tracking-wider">Educação</h3>
              <button className="flex items-center text-zinc-600 dark:text-zinc-400 font-bold text-xs hover:text-[#cc0000] dark:hover:text-red-500 uppercase tracking-wider transition-colors">
                Ver todas <ChevronRight className="w-3.5 h-3.5 ml-0.5"/>
              </button>
            </div>
