  ...
  return (
    <div className="w-full bg-white font-sans min-h-screen pb-20">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <article className="prose-editorial max-w-none prose-lg text-zinc-700">
          <div className="flex items-center gap-3 mb-8 text-[#cc0000]">
            <ShieldCheck className="w-8 h-8" />
            <h2 className="!mt-0 !mb-0 text-2xl font-black text-zinc-900">Nosso Compromisso com Seus Dados</h2>
          </div>
          ...
          <div className="bg-zinc-50 p-6 border-l-4 border-[#cc0000] mt-10 rounded-r-lg">
            <h4 className="!mt-0 text-xl font-bold text-zinc-900">Dúvidas?</h4>
            <p className="!mb-0">
              Se você tiver dúvidas sobre esta Política de Privacidade, entre em contato conosco através da nossa <a href="/contato" onClick={(e) => e.preventDefault()} className="text-[#cc0000]">página de contato</a>.
            </p>
          </div>
        </article>
      </div>
